...
do
   ...
   python main.py --network=unet --gpu_id=${gpu_id} --model_in_path=./models/group_${group_id}/model_${model_id}/model_${model_id}-${model_id} --data_in=${normalized_dir} --output_dir=${name_dir_output} --manual_splits=${normalized_dir}/manual_splits.txt
